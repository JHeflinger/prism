...
#define PREVIEW_PIPELINE_FLAGS 0b1100111
#define PATHTRACE_PIPELINE_FLAGS 0b1111011
#define HEADLESS_PIPELINE_FLAGS 0b0011011
#define HISTOGRAM_SHADER_FLAG 0b1
#define CENTROID_SHADER_FLAG 0b10
#define DEFAULT_SHADER_FLAG 0b100
#define PATHTRACE_SHADER_FLAG 0b1000
#define TONEMAP_SHADER_FLAG 0b10000
#define ANALYZE_SHADER_FLAG 0b100000
#define OVERLAY_SHADER_FLAG 0b1000000
