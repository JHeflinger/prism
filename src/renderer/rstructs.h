...
#define PREVIEW_PIPELINE_FLAGS 0b110011
#define PATHTRACE_PIPELINE_FLAGS 0b111101
#define HEADLESS_PIPELINE_FLAGS 0b001101
#define CENTROID_SHADER_FLAG 0b1
#define DEFAULT_SHADER_FLAG 0b10
#define PATHTRACE_SHADER_FLAG 0b100
#define TONEMAP_SHADER_FLAG 0b1000
#define ANALYZE_SHADER_FLAG 0b10000
#define OVERLAY_SHADER_FLAG 0b100000
