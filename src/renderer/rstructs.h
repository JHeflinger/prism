...
#define PREVIEW_PIPELINE_FLAGS   0b11001111111111
#define PATHTRACE_PIPELINE_FLAGS 0b11110111111111
#define HEADLESS_PIPELINE_FLAGS  0b00110111111111
#define CENTROID_SHADER_FLAG     0b1
#define HISTOGRAM_SHADER_FLAG    0b10
#define HISTORY_SHADER_FLAG      0b100
#define BUCKET_SHADER_FLAG       0b1000
#define SCATTER_SHADER_FLAG      0b10000
#define SWAP_SHADER_FLAG         0b100000
...
#define PATHTRACE_SHADER_FLAG    0b10000000000
